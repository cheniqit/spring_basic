...
public class AddressInfoRemoteService {
    ...
    public AddressByLocationResponse findAddressByLocation(String logLocation, String lanLocation){
        String remoteResult = HttpUtils.getData(Constant.AMAP_REMOTE_URL + String.format(this.REGEO, logLocation, lanLocation));
