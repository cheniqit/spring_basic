...
public class DateUtils extends Object {
    ...
    /** 时间格式. */
    public static final String FORMAT_DATE_CN_HH = "yyyy-MM-dd HH";
    /** 时间格式. */
    public static final String FORMAT_DATE_CN_HH_mm = "yyyy年MM月dd日 HH时mm分";

    /**时间格式. */
    public static final String FORMAT_DATE_HH = "HH时";
...
//            Date sDate = getDateFromString(second, FORMAT_DATE);
    ...
    public  static String getStringFormatDateHH(Date date){
        if(null==date){
            return "";
        }
        SimpleDateFormat sdf=new SimpleDateFormat(FORMAT_DATE_CN_HH);
    ...
    public  static String getStringFormatDate(Date date){
        ...
        SimpleDateFormat sdf=new SimpleDateFormat(FORMAT_DATE_CN);
        return   sdf.format(date);
    }

    public  static String getStringFormatDateHHmm(Date date){
        if(null==date){
            date = new Date();
        }
        SimpleDateFormat sdf=new SimpleDateFormat(FORMAT_DATETIME_HM);
        return   sdf.format(date);
    }

    public  static String getStringFormatDateHourHH(Date date){
        if(null==date){
            return "";
        }
        SimpleDateFormat sdf=new SimpleDateFormat(FORMAT_DATE_HH);
        return   sdf.format(date);
    }

    public  static String getStringFormatDateHourHHmmss(Date date){
        if(null==date){
            return "";
        }
