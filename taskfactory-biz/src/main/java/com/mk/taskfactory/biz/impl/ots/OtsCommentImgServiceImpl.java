...
import com.mk.taskfactory.biz.mapper.ots.OtsCommentImgMapper;
...
@Service
public class OtsCommentImgServiceImpl implements OtsCommentImgService {
    @Autowired
    private OtsCommentImgMapper mapper;
