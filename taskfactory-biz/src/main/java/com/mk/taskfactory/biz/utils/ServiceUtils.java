...
public class ServiceUtils {
    ...
    public static String doPost(String reqURL, Map<String, String> params){
        return sendPostRequestByJava(reqURL, params, ServiceUtils.timeout);
    }
    ...
    public static String sendGetRequest(String reqURL, String decodeCharset){
        ...
        try{
            ...
            LogUtils.error("该异常通常是协议错误导致,比如构造HttpGet对象时传入的协议不对(将'http'写成'htp')或者服务器端返回的内容不符合HTTP协议要求等,堆栈信息如下", e);
    ...
    public static String sendPostRequestByJava(String reqURL, Map<String, String> params, int timeout){
        ...
        return sendPostRequestByJava(reqURL, sendData.toString(), timeout);
    }
     ...
     * @return 远程主机响应正文`HTTP状态码,如<code>"SUCCESS`200"</code><br>若通信过程中发生异常则返回"Failed`HTTP状态码",如<code>"Failed`500"</code>
     */
    public static String sendPostRequestByJava(String reqURL, String sendData, int timeout){
